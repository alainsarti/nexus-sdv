Feature: Telemetry Data API
  ...
  Scenario: Get telemetry data for a specific time range
    ...
    When I request telemetry data for vehicle "VIN123456789ABCDEF" from "2024-01-15T09:15:00.000000000Z" to "2024-01-15T10:15:00.000000000Z" with data types:
      | data_type     |
      | dynamic:speed |
