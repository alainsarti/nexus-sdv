...
| :--- |:-----------------|:---------------------|:-----------------------------------------------------------------------------------------------------------------|
| **Go Client** | Real-time Stream | `dynamic`            | Simulates a continuous telemetry flow (e.g., battery metrics). |
| **Python Client** | Identity & State | `static` & `dynamic` | Demonstrates identity state and metadata handling.|
